...
- improve tracing - flux-weighted-mean centroid?
            ...
            for nod in ['A', 'B']:          # each nod point
                ...
                for i in range(nimgs):          # flat field correct each image
                    ...
                    if nod == 'A':
                        ...
                        o_nod = 'A'
                    # fimg -= (all_data[obj.replace(nod, o_nod)]['raw_imgs'][i] / flat)   # sky subtraction by nodding
                ...
                # object spectrum
                spc = np.asarray(sum_spectra(obj, s_row, method='optimal', imgs='flat_cor_imgs', mask=bad_pixel_mask))
